      ...
      <BrutalCard>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="flex-1">
            <BrutalInput icon={<Search className="w-5 h-5" />} placeholder="Search orders..." />
          </div>
          <div className="flex gap-2">
            <BrutalButton variant="outline" className="bg-neon-yellow border-black">
              Pending
            </BrutalButton>
            <BrutalButton variant="outline">
              Completed
          ...
          <table className="w-full font-mono text-sm border-collapse">
            <thead>
              <tr className="border-b-4 border-black">
                ...
                <th className="text-left py-4 px-4 uppercase font-bold bg-gray-100">Date</th>
                <th className="text-left py-4 px-4 uppercase font-bold bg-gray-100">Customer</th>
                <th className="text-left py-4 px-4 uppercase font-bold bg-gray-100">Items</th>
                <th className="text-left py-4 px-4 uppercase font-bold bg-gray-100">Total</th>
            ...
            <tbody>
              {[1, 2, 3, 4, 5].map((i) => (
                <tr key={i} className="border-b-2 border-gray-200 hover:bg-neon-pink/10 transition-colors">
                  <td className="py-4 px-4 font-bold">#ORD-2025-{880 + i}</td>
                  <td className="py-4 px-4 text-gray-500">Oct {12 + i}, 2025</td>
                  <td className="py-4 px-4">
                    <div className="font-bold">Cyber User {i}</div>
                    <div className="text-xs text-gray-500">user{i}@neobit.com</div>
                  </td>
                  <td className="py-4 px-4">
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-2">
                      {i === 1 ? (
                        <BrutalBadge variant="outline" className="bg-yellow-100 border-yellow-600 text-yellow-800">
                          <Clock className="w-3 h-3 mr-1" /> Processing
                        </BrutalBadge>
                      ) : i === 2 ? (
                        <BrutalBadge variant="outline" className="bg-blue-100 border-blue-600 text-blue-800">
                          <Truck className="w-3 h-3 mr-1" /> Shipped
                        </BrutalBadge>
                      ) : (
                        <BrutalBadge variant="neon" className="bg-green-100 border-green-600 text-green-800">
                  ...
                  <td className="py-4 px-4 text-right">
                    <BrutalButton size="sm" variant="ghost" className="hover:bg-black hover:text-white">
